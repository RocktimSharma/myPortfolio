    ...
    if request.method == 'POST':  # Checking if the request method is POST
        ...
        if form.is_valid():
            ...
            try:
                ...
                # Send the email
                email_message = EmailMessage('Thank you for your inquiry', email_content, 'dummymail58536@gmail.com', [email])
            ...
            return render(request, 'home.html',
                          context={'form': form, 'success': success,'fail':fail,'socials':socials,'myInfo':myInfo[0],'recent':recentWork,'skills':skills})

    else:
        form = ContactForm()  # Initializing ContactForm class
        return render(request, 'home.html',
                      context={'form': form,'socials':socials,'myInfo':myInfo[0],'recent':recentWork,'skills':skills})
